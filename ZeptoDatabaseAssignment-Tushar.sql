...
-- Table: OrderItem (normalization for many-to-many: orders and products)
...
-- Insert Users (Indian names and cities)
INSERT INTO User (full_name, phone_number, email, address) VALUES
('Ravi Sharma', '9876543210', 'ravi.sharma@gmail.com', 'Mumbai, Maharashtra'),
('Sneha Kapoor', '9898989898', 'sneha.kapoor@gmail.com', 'Delhi, India'),
...
INSERT INTO DeliveryAgent (agent_name, phone_number) VALUES
...
SELECT o.order_id, u.full_name AS customer, da.agent_name, o.delivery_status, o.total_amount
FROM Orders o
